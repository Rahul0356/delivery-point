                    ...
                    <div className="md:w-1/3 p-4 mt-8 md:mt-0">
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="mt-2">+91 9060209210</p>
                                <p className="mt-2">rahulkumar9199270356@gmail.com</p>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold">Address</h2>
                                <p className="mt-2">Marwadi college Hostel-c near Bedi, Rajkot 360003.</p>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold">Follow Me</h2>
                                <ul className="mt-2 space-y-1">
                                    <Link className='hover:text-orange-500 hover:underline' to="https://x.com/RMefgi" target='_blank'>TWITTER</Link><br/>
                                    <Link className='hover:text-orange-500 hover:underline' to="https://www.linkedin.com/in/rahul-kumar-6bb129245/" target='_blank'>LINKEDIN</Link><br/>
                                    <Link className='hover:text-orange-500 hover:underline' to="https://www.instagram.com/_rahul_arya143/" target='_blank'>INSTAGRAM</Link>
                                </ul>
                            </div>
                        </div>
                    </div>
